...
export declare abstract class ModalComponent<P, S> extends React.Component<P, S> {
    static alert: (title: React.ReactType, message: React.ReactType, actions?: Action[], platform?: string) => {
        close: () => void;
    };
    static prompt: (title: React.ReactType, message: React.ReactType, callbackOrActions: CallbackOrActions, type?: 'default' | 'secure-text' | 'login-password', defaultValue?: string, placeholders?: string[], platform?: string) => {
        close: () => void;
    };
